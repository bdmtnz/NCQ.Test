...
namespace NCQ.Test.Domain.Terms
{
    public sealed partial class Term
    {
        ...
        public static Term Create(TermId id, string code, string name = default, string slug = default, TermId parentId = default)
        {
            return new Term(id, code, name, slug, parentId);
        }
    }
}
